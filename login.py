...
def GET():
    ...
    S1=userbox.get()
    S2=passbox.get()
    if(S1=='Ashish' and S2=='Ashish'):
        menu()
    elif(S1=='ashish pandey' and S2=='MCA'):
        menu()
    else:
...
def Entry():
    ...
    bottomframe.pack()
    heading = tkinter.Label(topframe, text="Hospital Management System",bg='white',fg='orange',font='Times 16 bold italic')
